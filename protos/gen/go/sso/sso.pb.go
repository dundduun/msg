...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x04Auth\x12<\n" +
	"\bRegister\x12\x18.auth.CredentialsRequest\x1a\x16.auth.RegisterResponse\x126\n" +
	"\x05Login\x12\x18.auth.CredentialsRequest\x1a\x13.auth.LoginResponseB\x12Z\x10msg.sso.v1;ssov1b\x06proto3"
...
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.CredentialsRequest
	0, // 1: auth.Auth.Login:input_type -> auth.CredentialsRequest
